...
export default function FitnessProgramPage() {
  const accentColor = '#34B36B';

  const includes = [
    { icon: Dumbbell, text: 'Guided Fitness Sessions' },
    { icon: Sparkles, text: 'Strength & Mobility Training' },
    { icon: Heart, text: 'Community of Mothers' },
    { icon: Smile, text: 'Flexible Session Timings' },
  ];
          ...
          <div className="pd-block-inner">
            <div className="pd-blob">
              ...
              <div className="pd-blob-shape">
                <img src="/motherfit.png" alt="Mother Fitness Program" />
              </div>
            ...
            <div>
              <span className="pd-badge" style={{ backgroundColor: '#E3F7EA', color: accentColor }}>
                Mother Fitness Program
              </span>

              <h1 className="pd-title">
                Stay Active, <span style={{ color: accentColor }}>Stay You</span>
              </h1>

              <p className="pd-description">
                A guided fitness programme designed exclusively for mothers, built into our Premium
                Circle membership. Strength, mobility and energy-focused sessions led by experienced
              ...
              <div className="pd-bestfor">
                ...
                <span>
                  ...
                  Mothers who want a consistent, supportive fitness routine while their children
                  enjoy Playzone activities nearby.
                </span>
              </div>
