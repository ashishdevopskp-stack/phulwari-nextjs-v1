...
const campActivities = [
  {
    ...
    text: 'Creative activities that encourage imagination, artistic expression and hands-on learning through exciting projects.',
    color: '#34B36B',
    bg: '#E3F7EA',
  },
  {
    icon: Smile,
    title: 'Dance & Fun Movement',
    text: 'Energetic dance sessions that improve flexibility, confidence, coordination and physical fitness.',
    color: '#FF4D8D',
    bg: '#FFE6EF',
  },
  {
    ...
    text: 'Interactive music sessions that inspire creativity, rhythm, self-expression and enjoyment.',
    color: '#3D8BFF',
    bg: '#E5EFFF',
  },
  {
    ...
    text: 'Physical exercises and fun activities designed to improve strength, balance, flexibility and overall fitness.',
    color: '#E8A621',
    bg: '#FFF3D9',
  },
  {
    ...
    text: 'Exciting sports and team-based games that encourage healthy competition, teamwork and sportsmanship.',
    color: '#8B5CF6',
    bg: '#EFE7FE',
  },
  {
    icon: Brain,
    title: 'Yoga & Wellness',
    text: 'Simple yoga practices that help children improve focus, relaxation, flexibility and emotional well-being.',
    color: '#FF8A3D',
    bg: '#FFEADB',
  },
  {
    ...
    text: 'Interactive sessions focused on imagination, problem-solving, creativity and skill development.',
    color: '#3D8BFF',
    bg: '#E5EFFF',
  },
  {
    ...
    text: 'Engaging games, challenges and team-building exercises that make learning enjoyable and memorable.',
    color: '#FF4D8D',
    bg: '#FFE6EF',
  },
];
...
const learningPillars = [
  {
    ...
    bg: '#E3F7EA',
    icon: Dumbbell,
    items: ['Better Fitness', 'Improved Coordination', 'Enhanced Flexibility', 'Healthy Lifestyle Habits'],
  },
  {
    ...
    bg: '#FFE6EF',
    icon: Palette,
    items: ['Creative Thinking', 'Artistic Skills', 'Innovation', 'Imagination'],
  },
  {
    ...
    bg: '#E5EFFF',
    icon: Users2,
    items: ['Teamwork', 'Communication Skills', 'Friendship Building', 'Leadership Skills'],
  },
  {
    ...
    bg: '#EFE7FE',
    icon: Sparkles,
    items: ['Confidence', 'Discipline', 'Self-Expression', 'Positive Attitude'],
  },
];
...
/* Gallery images — swap these src paths for your real photos under /public/gallery/ */
const galleryImages = [
  { src: '/gallery/winter-camp-1.jpg', alt: 'Winter Camp Activities', tall: true },
  { src: '/gallery/winter-camp-2.jpg', alt: 'Art & Craft Sessions' },
  { src: '/gallery/winter-camp-3.jpg', alt: 'Dance Performances' },
  { src: '/gallery/winter-camp-4.jpg', alt: 'Sports & Games' },
  { src: '/gallery/winter-camp-5.jpg', alt: 'Music Activities', tall: true },
  { src: '/gallery/winter-camp-6.jpg', alt: 'Creative Workshops' },
  { src: '/gallery/winter-camp-7.jpg', alt: 'Competitions & Awards' },
];
    ...
    <>
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .wc-blob, .wc-blob-shape { animation: none !important; }
        }
        ...
        .wc-badge {
          ...
          background-color: #E5EFFF; color: #3D8BFF; border-radius: 9999px; font-size: 0.7rem;
        ...
        @media (min-width: 1024px) {
          .wc-hero-inner { grid-template-columns: 0.85fr 1.15fr; gap: 3rem; padding: 3rem; }
          .wc-blob { max-width: 23rem; }
          .wc-title { font-size: 2.5rem; }
        }
        ...
        .wc-highlight-icon {
          ...
          display: flex; align-items: center; justify-content: center; background-color: #E5EFFF;
        }
        ...
        /* ---------- Gallery ---------- */
        .wc-gallery-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.75rem; }
        .wc-gallery-item {
        ...
        .wc-gallery-item.tall { aspect-ratio: 1/1.35; }
        .wc-gallery-item img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.3s ease; }
        ...
        .wc-gallery-item:hover .wc-gallery-overlay { opacity: 1; }
        .wc-gallery-overlay span { color: #ffffff; font-size: 0.75rem; font-weight: 700; }
        @media (min-width: 640px) { .wc-gallery-grid { grid-template-columns: repeat(3, 1fr); } }
        @media (min-width: 1024px) { .wc-gallery-grid { grid-template-columns: repeat(4, 1fr); } }
        ...
        .wc-seats-inner {
          display: flex; align-items: center; gap: 0.75rem; background-color: #E5EFFF;
          border-radius: 18px; padding: 1rem 1.25rem; font-weight: 700; font-size: 0.9rem; color: #2563C9;
        }
      ...
      <div className="wc-page">
          ...
          <div className="wc-hero-inner">
            <div className="wc-blob">
              ...
              <div className="wc-blob-shape">
                <img src="/wintercamp.jpg" alt="Phulwari Winter Camp" />
              </div>
            ...
            <div>
              ...
              <h1 className="wc-title">
                Learn, Create <span>& Enjoy This Winter</span>
              </h1>
              ...
              <div className="wc-cta-buttons">
                <button className="wc-cta-button btn-register">
                  <Snowflake />
                  <span>Register Now</span>
                </button>
                <button className="wc-cta-button btn-call">
                  <Phone />
                  <span>Call Now</span>
                </button>
                <button className="wc-cta-button btn-whatsapp">
                  <MessageCircle />
        ...
        <section className="wc-section">
          <div className="wc-section-head">
            <h2 className="wc-section-title">
              Why Join <span>Our Winter Camp?</span>
            </h2>
            <p className="wc-section-text">
              Winter vacations should be more than just staying indoors. Our camp encourages
              children to stay active, explore new interests and build valuable life skills.
            </p>
          </div>
          <div className="wc-benefits-grid">
            {campBenefits.map((b, i) => {
              const Icon = b.icon;
              return (
                <div className="wc-benefit-item" key={i}>
                  <Icon />
                  <span>{b.text}</span>
                </div>
              );
        ...
        <section className="wc-section">
          ...
          <div className="wc-activities-grid">
            {campActivities.map((a, i) => {
              const Icon = a.icon;
              return (
                <div className="wc-activity-card" key={i}>
                  <div className="wc-activity-icon" style={{ backgroundColor: a.bg }}>
                    <Icon style={{ color: a.color }} />
                  </div>
                  <h3 className="wc-activity-title">{a.title}</h3>
                  <p className="wc-activity-text">{a.text}</p>
                </div>
              );
            })}
          </div>
        ...
        <section className="wc-section">
          <div className="wc-section-head">
            <h2 className="wc-section-title">
              What Children <span>Will Gain</span>
            </h2>
          </div>
          <div className="wc-pillars">
            {learningPillars.map((pillar, index) => {
              ...
              return (
                <div className="wc-pillar" key={index}>
                  <div className="wc-pillar-icon" style={{ backgroundColor: pillar.bg }}>
                    <Icon style={{ color: pillar.color }} />
                  </div>
                  <h3 className="wc-pillar-title">{pillar.title}</h3>
                  <div className="wc-pillar-list">
                    {pillar.items.map((item, i) => (
                      <div className="wc-pillar-item" key={i}>
        ...
        <section className="wc-section">
          <div className="wc-section-head">
            <h2 className="wc-section-title">
              Special Winter Camp <span>Highlights</span>
            </h2>
          </div>
          <div className="wc-highlights-grid">
            {highlights.map((h, i) => {
              const Icon = h.icon;
              return (
                <div className="wc-highlight-card" key={i}>
                  <div className="wc-highlight-icon">
                    <Icon />
                  </div>
                  <div>
                    <h3 className="wc-highlight-title">{h.title}</h3>
                    <p className="wc-highlight-text">{h.text}</p>
                  </div>
                </div>
              );
            })}
        ...
        <section className="wc-section">
          <div className="wc-section-head">
            <h2 className="wc-section-title">
              Why Parents Love <span>Our Winter Camp</span>
            </h2>
          </div>
          <div className="wc-benefits-grid">
            {parentFavorites.map((item, i) => (
              <div className="wc-benefit-item" key={i}>
                <ShieldCheck style={{ color: '#3D8BFF' }} />
                <span>{item}</span>
              </div>
            ))}
          </div>
        ...
        <section className="wc-section">
          <div className="wc-section-head">
            <h2 className="wc-section-title">
              Winter Camp <span>Gallery</span>
            </h2>
            <p className="wc-section-text">Explore memorable moments from our Winter Camp activities.</p>
          </div>
          <div className="wc-gallery-grid">
            {galleryImages.map((img, i) => (
              <div
                className={`wc-gallery-item ${img.tall ? 'tall' : ''}`}
                key={i}
                onClick={() => setLightboxImg(img.src)}
              >
                <img src={img.src} alt={img.alt} loading="lazy" />
                <div className="wc-gallery-overlay">
                  <span>{img.alt}</span>
                </div>
              </div>
            ))}
        ...
        <section className="wc-cta">
          <div className="wc-cta-box">
            ...
            <p className="wc-cta-text">
              Give your child a winter vacation filled with learning, creativity, friendship,
              confidence and fun.
            </p>
      ...
      {lightboxImg && (
        <div className="wc-lightbox" onClick={() => setLightboxImg(null)}>
          <button className="wc-lightbox-close" onClick={() => setLightboxImg(null)}>
            <X />
          </button>
