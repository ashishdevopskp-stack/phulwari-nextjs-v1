  ...
  return (
    <>
      <style>{`
        ...
        .footer-heading { font-family: 'Baloo 2', sans-serif; font-weight: 800; color: #ffffff; letter-spacing: -0.01em; }

        /* Brand */
        .footer-brand-row { display: flex; align-items: center; gap: 0.6rem; margin-bottom: 0.85rem; }
        .footer-brand-name { font-size: 1.3rem; line-height: 1.15; }
        .footer-tagline { font-weight: 700; font-size: 0.9rem; color: #FFD166; margin-bottom: 0.85rem; }
        .footer-description { font-weight: 600; font-size: 0.9rem; line-height: 1.65; color: #C7C0DC; max-width: 26rem; margin-bottom: 1.5rem; }

        /* Grid */
        .footer-grid {
          display: grid; grid-template-columns: 1fr; gap: 2.25rem;
          padding: 2.5rem 0 2.75rem;
          border-top: 1px solid rgba(255,255,255,0.08); margin-top: 1.5rem;
        }
        ...
        .footer-links-list a { font-weight: 600; font-size: 0.88rem; color: #C7C0DC; text-decoration: none; transition: color 0.15s ease; }
        .footer-links-list a:hover, .footer-links-list a.is-active { color: #FFD166; }

        /* Legal links */
        .footer-legal-divider { border: none; border-top: 1px solid rgba(255,255,255,0.08); margin: 1rem 0; }
        .footer-legal-label { font-size: 0.7rem; font-weight: 700; letter-spacing: 0.07em; text-transform: uppercase; color: #7A7393; margin-bottom: 0.6rem; }
        .footer-legal-list { list-style: none; display: flex; flex-direction: column; gap: 0.55rem; }
        .footer-legal-item {
          display: flex; align-items: center; gap: 0.5rem;
          font-weight: 600; font-size: 0.85rem; color: #C7C0DC;
          text-decoration: none; transition: color 0.15s ease;
        }
        .footer-legal-item:hover { color: #FFD166; }
        .footer-legal-item svg { width: 13px; height: 13px; stroke-width: 2.25; flex-shrink: 0; opacity: 0.7; }

        /* Tag list (activities / programs) */
        .footer-tag-list { display: flex; flex-direction: column; gap: 0.65rem; }
        .footer-tag-item { display: flex; align-items: center; gap: 0.55rem; text-decoration: none; transition: transform 0.15s ease; }
        ...
        .footer-tag-label { font-weight: 600; font-size: 0.86rem; color: #DCD7EB; transition: color 0.15s ease; }

        /* Contact */
        .footer-contact-item { display: flex; align-items: flex-start; gap: 0.65rem; margin-bottom: 1rem; }
        .footer-contact-icon { flex-shrink: 0; width: 30px; height: 30px; border-radius: 9999px; background-color: rgba(255,255,255,0.08); display: flex; align-items: center; justify-content: center; margin-top: 0.05rem; }
        .footer-contact-icon svg { width: 14px; height: 14px; stroke: #FFD166; stroke-width: 2.25; }
        .footer-contact-text { font-weight: 600; font-size: 0.86rem; line-height: 1.55; color: #DCD7EB; }
        .footer-contact-text a { color: #DCD7EB; text-decoration: none; }
        .footer-contact-text a:hover { color: #FFD166; }

        /* Working hours */
        .footer-hours-card { display: flex; align-items: flex-start; gap: 0.65rem; padding: 0.75rem; background-color: rgba(255,255,255,0.05); border-radius: 16px; margin-bottom: 0.75rem; }
        ...
        .footer-hours-title { font-weight: 700; font-size: 0.84rem; color: #ffffff; margin-bottom: 0.2rem; }
        .footer-hours-line { font-weight: 600; font-size: 0.78rem; color: #B7AFD1; line-height: 1.45; }

        /* Quick actions */
        .footer-actions-band { display: flex; flex-wrap: wrap; justify-content: center; gap: 0.7rem; padding-bottom: 2.25rem; }
        .footer-action-btn { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.7rem 1.25rem; border: none; border-radius: 9999px; color: #ffffff; font-family: 'Quicksand', sans-serif; font-weight: 700; font-size: 0.82rem; text-decoration: none; cursor: pointer; transition: transform 0.15s ease; }
        ...
        /* Bottom bar */
        .footer-bottom-bar { border-top: 1px solid rgba(255,255,255,0.08); padding: 1.25rem 0 1.75rem; text-align: center; }
        .footer-bottom-text { font-weight: 600; font-size: 0.78rem; color: #9991B3; line-height: 1.6; }
        .footer-bottom-text strong { color: #C7C0DC; font-weight: 700; }
        .footer-bottom-links { display: flex; justify-content: center; gap: 1.25rem; margin-top: 0.65rem; flex-wrap: wrap; }
        .footer-bottom-links a { font-size: 0.76rem; font-weight: 700; color: #7A7393; text-decoration: none; transition: color 0.15s ease; }
        .footer-bottom-links a:hover { color: #FFD166; }
        .footer-bottom-sep { color: #4A4360; }
        .footer-credit { font-weight: 600; font-size: 0.78rem; color: #9991B3; margin-top: 0.4rem; }
